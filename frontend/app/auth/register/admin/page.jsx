...
import { FaUser, FaEnvelope, FaLock, FaPhone, FaShieldAlt, FaBuilding } from 'react-icons/fa';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative bg-black items-center justify-center">
        ...
        <div className="relative z-10 p-8 text-center">
          <h3 className="text-4xl font-bold text-white mb-4">Admin Access</h3>
          <p className="text-gray-400 max-w-md mx-auto">
            Join as an administrator to manage the AttendEase system. Monitor attendance, manage users, and ensure smooth operations.
          </p>
        </div>
      </div>
    </div>
