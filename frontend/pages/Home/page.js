        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Streamline your attendance tracking with our QR-based system. Easy to use,
              reliable, and perfect for organizations of all sizes.
            </p>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our system combines QR technology with powerful management tools to make
              attendance tracking effortless.
            </p>
          </div>
